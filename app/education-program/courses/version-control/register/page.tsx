...
export default function VersionControlRegistrationPage() {
  return (
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="bg-blue-600 p-6 text-white">
              <h1 className="text-2xl md:text-3xl font-bold">Register for Version Control Systems Course</h1>
              <p className="mt-2 text-blue-100">
                Complete the form below to enroll in our comprehensive version control course.
              </p>
            </div>
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="mt-6 text-center text-gray-600 text-sm">
                <p>
                  Already registered?{" "}
                  <Link href="/education-program/student-dashboard" className="text-blue-600 hover:text-blue-800">
          ...
          <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p className="ml-2 text-gray-700">Duration: 8 weeks, 3 hours/week</p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <p className="ml-2 text-gray-700">Prerequisites: Basic computer skills</p>
              </div>
            ...
            <div className="mt-6">
              <Link
                href="/education-program/courses/version-control"
